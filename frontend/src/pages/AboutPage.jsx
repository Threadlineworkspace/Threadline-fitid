...
//                   </div>
//                 </div>
//                 <Button asChild className="mt-8 bg-[#fa6902] hover:bg-[#B85D2A] text-white">
//                   <Link to="/fitid">
//                     Join the Movement
  ...
  return (
    <div className="pt-20 overflow-hidden bg-black">
      ...
      <section className="relative py-24 bg-black">
        <div className="absolute inset-0 bg-gradient-to-b from-[#fa6902]/5 to-transparent pointer-events-none" />
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1 }}
              transition={{ delay: 0.3, type: 'spring', stiffness: 200 }}
              className="w-20 h-20 bg-[#fa6902]/20 rounded-2xl flex items-center justify-center mx-auto mb-8"
            >
              <Gem className="w-10 h-10 text-[#fa6902]" />
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-5xl mx-auto">
            ...
            >
              {[
                ...
                <div key={index} className="p-6 bg-[#111111] border border-white/10 rounded-xl text-center">
                  <div className="text-2xl font-bold text-[#fa6902]">{stat.value}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1, duration: 0.6 }}
                className="group p-6 bg-[#111111] rounded-xl hover:shadow-xl transition-all duration-300 border border-white/10 hover:border-[#fa6902]/40"
              >
                <div className="w-12 h-12 bg-[#fa6902]/20 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <value.icon className="w-6 h-6 text-[#fa6902]" />
                </div>
      ...
      <section className="py-20 bg-black border-t border-white/10">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="max-w-4xl mx-auto"
          >
            <div className="relative p-12 bg-[#111111] border border-white/10 rounded-3xl text-white overflow-hidden">
