...
export const triangleEmail = ({ firstName }) => {
  const content = `
    ...
    <div class="section">
      ...
      <ul class="list">
        <li>Greater waist-to-hip ratio variance</li>
        <li>Increased lower-body circumference concentration</li>
        <li>Higher likelihood of waist-to-hip fit conflict in standard sizing systems</li>
      </ul>
    </div>
    ...
    <div class="section">
      <p style="font-size: 15px; line-height: 1.6; color: #333;">
        Women with greater hip-to-waist differentials often experience a fundamental fit conflict within standard sizing systems.
      </p>
      <p style="font-size: 15px; line-height: 1.6; color: #333;">
        Garments may fit the waist but restrict movement through the hips and thighs — or provide sufficient lower-body room but lose stability at the waist.
      </p>
    </div>
    ...
    <div class="section">
      ...
      <p style="font-size: 15px; line-height: 1.6; color: #333;">
        Many work trousers are designed around a relatively fixed relationship between waist, hip and thigh measurements. When body proportions differ significantly from that relationship, garments often struggle to provide both secure waist fit and unrestricted lower-body movement at the same time.
      </p>
    </div>
    ...
    <div class="section">
      ...
      <ul class="list">
        <li>waistbands that fit the hips but feel loose at the waist</li>
        <li>restriction through the hips and thighs during movement</li>
        <li>tension through the seat when crouching, kneeling or climbing</li>
        <li>sizing compromises between comfort and stability</li>
        <li>increased wear in high-friction zones</li>
      </ul>
      <p style="font-size: 15px; line-height: 1.6; color: #333; font-style: italic; margin-top: 10px;">
        Most workwear isn't designed around these proportion and movement mechanics.
      </p>
    </div>
